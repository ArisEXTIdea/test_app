...
<div id="main-container" class="mb-10">
    <div id="header-section" class="w-full py-5 bg-sky-600">
        <h1 class="text-white text-center font-bold text-2xl">Edit Akun</h1>
    </div>
        ...
        <div id="form-section" class="w-11/12 md:w-2/3 py-10 bg-white drop-shadow-lg rounded-lg p-10">
            <form action="/editData" method="post">
                <div class="mb-3 hidden">
                    ...
                    <input type="text" name="uid" class="w-full py-3 px-5 border rounded-lg mt-2" placeholder="contoh: Putra Pratama" value="<?= $userData['uid'] ?>">
                </div>
                <div class="mb-3">
                    <label for="name">Nama Lengkap</label>
                    <input type="text" name="name" class="w-full py-3 px-5 border rounded-lg mt-2" placeholder="contoh: Putra Pratama" value="<?= $userData['name'] ?>">
                </div>
                <div class="mb-3">
                    <label for="email">Email</label>
                    <input type="email" name="email" class="w-full py-3 px-5 border rounded-lg mt-2" placeholder="contoh: akunku@gmail.com" value="<?= $userData['email'] ?>">
                </div>
                <div class="mb-3">
                    <label for="password">Password</label>
                    <input type="password" name="password" class="w-full py-3 px-5 border rounded-lg mt-2" placeholder="Buat password baru" value="<?= $userData['password'] ?>">
                </div>
                <div class="mb-3">
                    <label for="address">Alamat</label>
                    <input type="text" name="address" class="w-full py-3 px-5 border rounded-lg mt-2" placeholder="contoh: Jl.Patimura no.100" value="<?= $userData['address'] ?>">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select  name="status" class="w-full py-3 px-5 border rounded-lg mt-2">
                        ...
                        <option value="1" <?= $userData['status'] == '1'? 'selected': '' ?>> Aktif</option>
                        <option value="0" <?= $userData['status'] == '0'? 'selected': '' ?>> Tidak Aktif</option>
                    </select>
                </div>
                <div class="mb-3">
                    ...
                    <select  name="level" class="w-full py-3 px-5 border rounded-lg mt-2">
                        ...
                        <option value="0" <?= $userData['level'] == '0'? 'selected': '' ?>> Super User</option>
                        <option value="1" <?= $userData['level'] == '1'? 'selected': '' ?>> Site Administrator</option>
                        <option value="2" <?= $userData['level'] == '2'? 'selected': '' ?>> Admin</option>
                        <option value="3" <?= $userData['level'] == '3'? 'selected': '' ?>> User</option>
                    </select>
                </div>
                <div class="mb-3">
